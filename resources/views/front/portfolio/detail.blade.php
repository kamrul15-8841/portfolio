                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p><strong>Description: I designed this project using HTML, CSS, Bootstrap and Laravel. It has an admin panel where admin can upload content like video,
image, description and manage content with crud operation.
After upload content it will show user.</strong></p>
